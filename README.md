...
<br />
<div align="center">
  <a href="https://t.me/zoo_story_bot/game?startapp=ref1178697351">
...
<h3 align="center">Auto <a href="https://t.me/zoo_story_bot/game?startapp=ref1178697351">@Zoo_Story_Bot</a> 1.2</h3>
  <p align="center">
    ...
    <br />
    <a href="https://github.com/m3taphor/ZooStory/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    •
    <a href="https://github.com/m3taphor/ZooStory/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
[![ZooStory][product-screenshot]](https://t.me/zoo_story_bot/game?startapp=ref1178697351)

An automated script/code made by @m3taphor on [Python 3.10](https://www.python.org/downloads/release/python-3100/) for [@zoo_story_bot](https://t.me/zoo_story_bot/game?startapp=ref1178697351), built using ZooStory app APIs. It supports multiple sessions through [Pyrogram](https://github.com/pyrogram/pyrogram), with custom proxy support via an `accounts.json` configuration file.
...
> [!WARNING]
> Please be aware that using this script may result in your [@zoo_story_bot](https://t.me/zoo_story_bot/game?startapp=ref1178697351) account being banned due to violating terms of service (e.g., cheating). Use at your own risk. The author assumes no responsibility for any consequences.
...
| **REF_KEY**              |                 Start with refer, ID which is after `startapp=` (eg. `ref1178697351`)                  |
| **TRACK_BOT_UPDATES**    |                              Track Changes in Bot API (default - `True`)                               |
| **MAX_REQUEST_RETRY**    |                           Max retry the ratelimited request (default - `3`)                            |
| **FLOOD_WAIT**           |                           Telegram Rate-limit flood wait (default - `False`)                           |
| **AUTO_SIGN_IN**         |                                 Auto Check-in Daily (default - `True`)                                 |
| **AUTO_TASK**            |                                 Auto complete tasks (default - `True`)                                 |
| **AUTO_JOIN_CHANNELS**   |               [Auto Task]: Auto join telegram channels to complete task (default - True)               |
...
1. Clone the repo
   ```sh
   git clone https://github.com/m3taphor/ZooStory.git
   ```
...
More Info on [LICENSE](https://github.com/m3taphor/ZooStory/blob/main/LICENSE) file.

<p align="right">(<a href="#readme-top">back to top</a>)</p>

[forks-shield]: https://img.shields.io/github/forks/m3taphor/ZooStory.svg?style=for-the-badge&logo=data:image/svg%2bxml;base64,
[forks-url]: https://github.com/m3taphor/ZooStory/network/members
[stars-shield]: https://img.shields.io/github/stars/m3taphor/ZooStory.svg?style=for-the-badge&logo=data:image/svg%2bxml;base64,
[stars-url]: https://github.com/m3taphor/ZooStory/stargazers
[license-shield]: https://img.shields.io/github/license/m3taphor/ZooStory.svg?style=for-the-badge
[license-url]: https://github.com/m3taphor/ZooStory/blob/main/LICENSE
...
[product-screenshot]: https://i.ibb.co/WpByyrt/image.png
